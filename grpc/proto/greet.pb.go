...
const file_proto_greet_proto_rawDesc = "" +
	...
	"\fGreetService\x126\n" +
	"\tSayHello1\x12\x13.greet.HelloRequest\x1a\x14.greet.HelloResponse\x126\n" +
	"\tSayHello2\x12\x13.greet.HelloRequest\x1a\x14.greet.HelloResponseB\x11Z\x0fgrpc-demo/protob\x06proto3"
...
var file_proto_greet_proto_depIdxs = []int32{
	0, // 0: greet.GreetService.SayHello1:input_type -> greet.HelloRequest
	0, // 1: greet.GreetService.SayHello2:input_type -> greet.HelloRequest
	1, // 2: greet.GreetService.SayHello1:output_type -> greet.HelloResponse
	1, // 3: greet.GreetService.SayHello2:output_type -> greet.HelloResponse
